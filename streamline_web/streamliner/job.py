...
class Job:
   ...
   def queued_status(self):
      self.status = "Queued"
      self.message = "Streamline is currently queued for run"
      self.success = True
      self.complete = False
      self.save()
   ...
   def started_status(self):
      self.status = "Running"
      self.message = "Streamline is currently running"
      self.success = True
      self.complete = False
      self.save()
   ...
   def completed_status(self):
      ...
      self.message = "Streamline complete!"
      self.success = True
      self.complete = True
      self.save()
